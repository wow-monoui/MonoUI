...
cfg.modules = {
	...
	chat = {		-- chat module settings
		...
		["editbox_width"] = 465,						-- Editbox width
	...
	raid_buffs = {
		...
		["position"] = {"BOTTOMRIGHT","UIParent","BOTTOMRIGHT",-487,20},
		["size"] = 26,						-- icons size
	...
	shout_cooldowns		= {					-- automatic CD use announcement
		...
		["cd_list"] = {						-- set CD shout out for certain spells
			{	id = 16190, 				-- spell id (mana tide totem)
				...
				WarnTime = 30,  			-- (OPTIONAL) warning time in seconds before CD completion
			},
			-- spirit link totem
			{id = 98008,	AnnounceChan = "RAID",  	WarnChan = "RAID",  	ChanIndex = 5,	Duration = 6}, 
			-- stormlash totem
			{id = 120668,	AnnounceChan = "RAID",  	WarnChan = "RAID",  	ChanIndex = 5,	Duration = 10}, 
			-- healing tide totem
			{id = 108280,	AnnounceChan = "RAID",  	WarnChan = "RAID",  	ChanIndex = 5,	Duration = 10}, 
			-- guardian of ancient kings
			{id = 86659,	AnnounceChan = "RAID",  	WarnChan = "RAID",  	ChanIndex = 5,	Duration = 12}, 
			-- guardian spirit
			{id = 47788,	AnnounceChan = "RAID",  	WarnChan = "RAID",  	ChanIndex = 5}, 
			-- pw: barrier
			{id = 62618,	AnnounceChan = "RAID",  	WarnChan = "RAID",  	ChanIndex = 5,	Duration = 10}, 
			-- pain suppression
			{id = 33206,	AnnounceChan = "RAID",  	WarnChan = "RAID",  	ChanIndex = 5,	Duration = 8}, 
			-- Rallying cry
			{id = 97463,	AnnounceChan = "RAID",  	WarnChan = "RAID",  	ChanIndex = 5,	Duration = 10}, 
			-- Skull Banner
			{id = 114207,	AnnounceChan = "RAID",  	WarnChan = "RAID",  	ChanIndex = 5,	Duration = 10}, 
	}},	
}
...
if GetUnitName("player") == "Strigoy" or GetUnitName("player") == "Strig" then
	...
	cfg.automation.shout_cooldowns.cd_list = {
		{	id = 16190,	AnnounceChan = "SAY",   	WarnChan = "CHANNEL",	ChanIndex = 5,	Duration = 16}, -- mana tide totem
		{	id = 98008,	AnnounceChan = "CHANNEL",  	WarnChan = "CHANNEL",	ChanIndex = 5,	Duration = 6}, -- spirit link totem
		{	id = 120668,AnnounceChan = "RAID",		WarnChan = "RAID",		ChanIndex = 6,	Duration = 10}, -- stormlash totem
		{	id = 120668,AnnounceChan = "CHANNEL",	WarnChan = "CHANNEL",	ChanIndex = 7,	Duration = 10}, -- stormlash totem 2
		{	id = 108280,AnnounceChan = "CHANNEL",	WarnChan = "RAID",		ChanIndex = 5,	Duration = 10}, -- healing tide totem
		{	id = 86659,	AnnounceChan = "CHANNEL",	WarnChan = "CHANNEL",	ChanIndex = 5,	Duration = 12}, -- guardian of ancient kings
		{	id = 47788,	AnnounceChan = "CHANNEL",	WarnChan = "CHANNEL",	ChanIndex = 5}, -- guardian spirit
		{	id = 62618,	AnnounceChan = "CHANNEL",	WarnChan = "CHANNEL",	ChanIndex = 5,	Duration = 10}, -- pw: barrier
		{	id = 33206,	AnnounceChan = "CHANNEL",	WarnChan = "CHANNEL",	ChanIndex = 5,	Duration = 8}, -- pain suppression
		{	id = 97463,	AnnounceChan = "RAID",		WarnChan = "RAID",		ChanIndex = 5,	Duration = 10}, -- Rallying cry
		{	id = 114207,AnnounceChan = "RAID",		WarnChan = "RAID",		ChanIndex = 5,	Duration = 10}, -- Skull Banner
