...
function Implementation:GetItemInfo(bagID, slotID, i)
	...
	if(clink) then
		i.texture, i.count, i.locked, i.quality, i.readable, _ = GetContainerItemInfo(bagID, slotID)
		...
		local texture
		i.name, i.link, i.rarity, i.level, i.minLevel, i.type, i.subType, i.stackCount, i.equipLoc, texture, _ = GetItemInfo(clink)
