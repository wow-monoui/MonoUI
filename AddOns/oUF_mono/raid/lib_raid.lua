...
lib_raid.upd_elements = function(f)
    f:RegisterEvent('PLAYER_FOCUS_CHANGED', FocusTarget, true)
    f:RegisterEvent('GROUP_ROSTER_UPDATE', FocusTarget, true)
    f:RegisterEvent('PLAYER_TARGET_CHANGED', ChangedTarget, true)
    f:RegisterEvent('GROUP_ROSTER_UPDATE', ChangedTarget, true)
end
