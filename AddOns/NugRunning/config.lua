...
Spell({31821} ,{ name = "Devotion Aura", duration = 6, priority = -100, color = colors.DRED, shine = true, affiliation = "raid", target = "player" })
...
--Spell( 73920 ,{ name = "Healing Rain", duration = 10, glowtime = 10, color = { 77/255, 177/255, 77/255} })
--Spell( 73920 ,{ name = "Healing Rain", color = colors.LGREEN, group = "buffs"  })
...
Spell( 77762 ,{ name = "Flame Surge", duration = 18, shine = true, glowtime = 5, color = { 192/255, 77/255, 48/255}, short = "Lava Surge"})
