		...
		for bagKey, bagSlot in pairs(group.bagSlotNumbers) do
			...
			for itemSlot=1, GetContainerNumSlots(bagSlot) do
				...
				if itemLink ~= nil then
					...
					--higher quality - uncommon
					elseif itemRarity == 2 then
						newItem.sortString = newItem.sortString .. BS_QUALITY*1.1
					--higher quality - rare
					elseif itemRarity == 3 then
						newItem.sortString = newItem.sortString .. BS_QUALITY*1.2
					--higher quality - epic
					elseif itemRarity == 4 then
						newItem.sortString = newItem.sortString .. BS_QUALITY*1.3
					--higher quality - legendary
					elseif itemRarity == 5 then
						newItem.sortString = newItem.sortString .. BS_QUALITY*1.4
					--higher quality -
					else
						newItem.sortString = newItem.sortString .. BS_QUALITY*1.5
					end
