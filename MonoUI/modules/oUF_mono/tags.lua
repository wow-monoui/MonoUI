...
oUF.Tags.Events['mono:color'] = 'UNIT_HEALTH UNIT_DISPLAYPOWER'
...
oUF.Tags.Events['mono:hpperc'] = 'UNIT_HEALTH UNIT_MAXHEALTH UNIT_CONNECTION'
...
oUF.Tags.Events['mono:hpraid'] = 'UNIT_HEALTH UNIT_MAXHEALTH UNIT_CONNECTION'
...
oUF.Tags.Events['mono:DDG'] = 'UNIT_NAME_UPDATE UNIT_HEALTH UNIT_MAXHEALTH UNIT_CONNECTION'--'UNIT_MAXHEALTH'
...
oUF.Tags.Methods['mono:pvp'] = function(u)
  if(UnitIsPVP(u)) and u == "player" and cfg.oUF.settings.pvp_flag then
    return '|cffF93838[P]|r'
  end
end
oUF.Tags.Events['mono:pvp'] = 'UNIT_FACTION'
...
oUF.Tags.Methods['mono:sf'] = function(u)
  name, _, count, _, duration = ns.lib.UnitBuff("player", 203981)
  local cpcol = {"8AFF30","FFF130","FF6161"}
...
-- Holy Pwower
oUF.Tags.Methods['mono:holyp'] = function(u)
  count = UnitPower(u, 9)
  local cpcol = {"8AFF30","FFF130","FF6161"}
  if count == 1 then return "|cff"..cpcol[1].."_|r"
  elseif count == 2 then return "|cff"..cpcol[1].."_ _|r"
...
oUF.Tags.Events['mono:holyp'] = 'UNIT_POWER_UPDATE'
-- special powers
-- water shield
oUF.Tags.Methods['mono:ws'] = function(u)
  local name, _, count, _, duration = ns.lib.UnitBuff("player", 52127)
  if name then
    return "|cff8AFF30_|r"
  end
end
...
oUF.Tags.Methods['mono:ls'] = function(u)
  local lsn, _, lsc = ns.lib.UnitBuff("player", 192106)
  local mw, _, mwc = ns.lib.UnitBuff("player", 187880)
  if mw then
    if mwc == 1 then
      return "|cff8AFF30_|r"
    elseif mwc == 2 then
