...
cfg.oUF = {
  ...
  settings = {
    ...
    pvp_flag = false, -- enables PVP flag next to player's name
  ...
  frames = {
    ...
    raid = {
      -- Raid frames configuration
      ["enable"] = true,
      ["position"] = {"TOPLEFT", "UIParent", "BOTTOM", -156, 177},
      ["party"] = true, -- show party as 5 men raid group
      ["raid5"] = true, -- show raid frame for 5 (or less) men raid group
