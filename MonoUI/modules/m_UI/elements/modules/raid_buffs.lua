...
-- Unit aura replacement
local function Locat_UnitAura(unit, spellName)
	local name, icon, _, _, _, etime = UnitAura(unit, 1)
...
local ButtonOnEnter = function(self,descr)
	GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
	GameTooltip:AddLine(descr, 1, 1, 1)
...
local function OnAuraChange(self, event, arg1, unit)
	...
	if flaskbuffs and flaskbuffs[1] then
		...
		for i, flaskbuffs in pairs(flaskbuffs) do
			...
			if Locat_UnitAura("player", spellname) then
...
do
	...
	FlaskFrame:SetScript("OnEnter",function(self) ButtonOnEnter(self, "Flask") end)
	FlaskFrame:SetScript("OnLeave",ButtonOnLeave)
	FoodFrame:SetScript("OnEnter",function(self) ButtonOnEnter(self, "Food") end)
	FoodFrame:SetScript("OnLeave",ButtonOnLeave)
	buff1Frame:SetScript("OnEnter",function(self) ButtonOnEnter(self, "Stats") end)
	buff1Frame:SetScript("OnLeave",ButtonOnLeave)
	buff2Frame:SetScript("OnEnter",function(self) ButtonOnEnter(self, "Stamina") end)
	buff2Frame:SetScript("OnLeave",ButtonOnLeave)
	buff3Frame:SetScript("OnEnter",function(self) ButtonOnEnter(self, PlayerIsCaster() and "Spell power" or "Attack Power") end)
	buff3Frame:SetScript("OnLeave",ButtonOnLeave)
	buff4Frame:SetScript("OnEnter",function(self) ButtonOnEnter(self, "Mastery") end)
	buff4Frame:SetScript("OnLeave",ButtonOnLeave)
end
