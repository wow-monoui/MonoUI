...
SlashCmdList["MODEL"] = function(s)
	if s == "dj" then
		local d = EncounterJournalEncounterFrameInfoModelFrame
		d:ClearAllPoints() 
		...
		EncounterJournalEncounterFrameInfoModelFrameTitleBG:Hide()
		EncounterJournalEncounterFrameInfoModelFrameDungeonBG:Hide()
		A.make_backdrop(d)
